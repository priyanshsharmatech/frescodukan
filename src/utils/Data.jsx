...
export const products = [
   ...
   { id: 3, name: "Chipsona Potato - New Crop (Alu)", category: "Vegetables", price: 31, image: potato, quantity:"1kg", unit:1 },
   { id: 4, name: "Ginger (Adrak)", category: "Vegetables", price: 25, image: ginger, quantity:"200gm", unit:1 },
   { id: 5, name: "Orange Carrot (Gajar)", category: "Vegetables", price: 22, image: carrot, quantity:"500g", unit:1 },
   { id: 6, name: "Green Cucumber (Kheera)", category: "Vegetables", price: 27, image: cucumber, quantity:"(500-700g)", unit:1 },
   { id: 7, name: "Cauliflower (Phoolgobi)", category: "Vegetables", price: 33, image: cauliflower, quantity:"1 piece (300-500 g)", unit:1 },
   { id: 8, name: "Onion (Pyaj)", category: "Vegetables", price: 36, image: onion, quantity:"(0.95-1.05) kg", unit:1 },
   ...
   { id: 11, name: "Green Capsicum (Shimla Mirch)", category: "Vegetables", price: 23, image: shimla, quantity:"(250-280) g", unit:1 },
   { id: 12, name: "Raw Papaya (Kacha Papita)", category: "Vegetables", price: 48, image: papaya, quantity:"1 piece (400-600 g)", unit:1 },
   { id: 13, name: "Cabbage (Bandgobi)", category: "Vegetables", price: 17, image: cabbage, quantity:"1 piece (400-600 g)", unit:1 },
   ...
   { id: 16, name: "Brown Coconut (Nariyal)", category: "Fruits", price: 55, image: coconut, quantity:"1 piece", unit:1 },
   ...
   { id: 19, name: "Valencia Navel Orange (Imported) (Santara)", category: "Fruits", price: 85, image: orange, quantity:"(350-450) g", unit:1 },
   { id: 20, name: "Safeda / Banganapalli Mango (Saphede aam)", category: "Fruits", price: 170, image: mango, quantity:"2 pieces (550-700 g)", unit:1 },
   { id: 21, name: "Sweet Lime (Mosambi)", category: "Fruits", price: 65, image: Lime, quantity:"1 kg (9-10 pieces)", unit:1 },
   { id: 22, name: "Meat Cut Basa (without Head &Tail)", category: "Meat", price: 369, image: fish, quantity:"500g", unit:1 },
