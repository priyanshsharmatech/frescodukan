    ...
    <div className="bg-gray-100">
      <div className="max-w-6xl mx-auto py-12 px-4 mt-16">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold mb-4 text-green-700">About FrescoDukan</h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center md:mb-20">
          <div>
            ...
            <div className="space-y-4 text-gray-600">
              <p>
                FrescoDukan began with a simple idea: to create a grocery store that offers the freshest produce, highest
                quality meats, and finest selection of everyday essentials at fair prices.
              </p>
              <p>
                Founded in 2005 by the Sharma family, our first store opened in Grocery City with just 15 employees.
        ...
        <div className="bg-green-50 p-8 rounded-lg">
          <h2 className="text-2xl font-semibold mb-4 text-green-600 text-center">Join the FrescoDukan Family</h2>
