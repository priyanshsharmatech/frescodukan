...
import Logo from "../assets/frescologo.png"
...
function Navbar() {
  ...
  return (
    <div>
      <div className='mx-auto flex justify-between items-center px-6 py-5 fixed top-0 z-20 bg-green-100 w-full border border-gray-100 shadow-xl lg:px-[180px]'>
           {/* logo section */}
