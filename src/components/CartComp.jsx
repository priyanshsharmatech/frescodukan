...
function CartComp({ isOpen, onClose }) {
            ...
            </div>
            {
                cart.length > 0 && (
                    <div className='bg-white p-5 rounded-md'>
                        <div className='bg-green-600 hover:bg-green-700 text-white w-full py-2 px-3 rounded-md flex justify-between items-center cursor-pointer'>
                            <div>
