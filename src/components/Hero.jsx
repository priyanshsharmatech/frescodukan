            ...
            <div className='max-w-6xl mx-auto py-16 flex flex-col md:flex-row items-center px-6 md:px-0 gap-7'>
                <div className='md:w-1/2 mb-8 md:mb-0'>
                    ...
                    <div className='flex flex-wrap gap-4 items-center'>
                        <Link to={'/shop'}><button className='cursor-pointer bg-white text-green-600 hover:bg-gray-200 rounded-full px-3 py-2'>Shop Now</button></Link>
                        <Link to={'/about'}><button className='text-white cursor-pointer border-white bg-green-800 hover:bg-green-700 rounded-full px-3 py-2'>Learn More</button></Link>
                    </div>
                </div>
