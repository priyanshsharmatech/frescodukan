    ...
    <footer className='bg-gray-800 text-white py-12 px-4 md:px-0'>
      <div className='max-w-6xl mx-auto'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
            <div>
                <h3 className='text-xl font-bold mb-4'>FrescoDukan</h3>
            ...
            <div>
                ...
                <p className='mb-2'>Email: info@frescodukan.com</p>
            </div>
        </div>
        <div className='mt-8 pt-8 border-t border-gray-700 text-center'>
            <p>&copy; {new Date().getFullYear()} <span className='font-semibold'>FrescoDukan</span>. All rights reserved</p>
        </div>
      </div>
    </footer>
  )
